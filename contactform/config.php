...
define('CONTACTFORM_FROM_ADDRESS', 'mailer@midbarayazamut.co.il');
define('CONTACTFORM_FROM_NAME', 'Contact Form on midbarayazamut.co.il');
...
define('CONTACTFORM_TO_ADDRESS', 'midbarayazamut@gmail.com');
define('CONTACTFORM_TO_NAME', 'Doron Lisbona');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'midbarayazamut@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'gnjzngeqrlwmuxwb');
// define('CONTACTFORM_SMTP_PASSWORD', 'wspyknfadyaqzwwl');
